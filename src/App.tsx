            ...
            <DialogContent className="max-w-2xl">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="image" className="space-y-4 mt-4">
                  <Alert>
                    <AlertDescription>
                      Upload an image with text to extract and read. Supported formats: JPG, PNG, etc.
                    </AlertDescription>
                  </Alert>
                  ...
                  {isParsing && (
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-400 text-center">{ocrProgress}% - Processing image...</p>
                    </div>
                  )}
                  ...
                  {inputText && activeTab === 'image' && !isParsing && (
                    <div className="space-y-2">
